import { ActionRowBuilder, ButtonBuilder, ButtonStyle, Events, Guild } from 'discord.js';
...
export default {
    ...
    execute: async (guild: Guild) => {
        ...
        const embed = new InfoEmbed(
            ...
            .setImage('https://raw.githubusercontent.com/WeismanGitHub/Population-Map-Discord-Bot/main/images/WORLD2-example.jpg');
