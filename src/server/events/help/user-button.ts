...
export default {
    ...
    execute: async (interaction: ButtonInteraction) => {
        ...
        const userDocs = "Countries and subdivisions are from [ISO 3166](https://www.iso.org/iso-3166-country-codes.html). You can delete your data with `/user-delete` and view your location with `/user-settings`."
